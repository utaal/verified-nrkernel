...
pub open spec fn IsReadonlyTicket<DT: Dispatch>(
...
pub open spec fn IsReadonlyStub<DT: Dispatch>(
...
pub open spec fn IsUpdateTicket<DT: Dispatch>(
...
pub open spec fn IsUpdateStub<DT: Dispatch>(
