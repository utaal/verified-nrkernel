...
//            forall(|a: nat| (a != 0) ==> (aligned(0, a))),
//            forall(|a: nat, b: nat, c: nat| (a > b && c > 0 && aligned(b, c) && #[trigger] (a % c) > 0) ==> (#[trigger] (a - b) % c > 0)),
//            // TODO: rewrite these two to a single ensures with with_triggers
//            forall(|a: nat, b: nat| (a + 1) * b == #[trigger] (a * b + b)),
//            forall(|a: nat, b: nat| #[trigger] ((a + 1) * b) == (a * b + b)),
//            // bad triggers:
//            forall(|a: nat, b: nat| #[trigger] (a * b) == b * a),
//            forall(|a: nat, b: nat| (aligned(a, b) && b != 0) ==> (#[trigger] (a / b * b) == a)),
//            forall(|a: nat, b: nat, c: nat| (#[trigger] (a * c) < #[trigger] (b * c)) ==> (a < b)),
//            forall(|a: nat, b: nat, c: nat| (a <= b) ==> (#[trigger] (a * c) <= #[trigger] (b * c))),
//            forall(|a: nat, b: nat, c: nat| (a <= b) ==> (#[trigger] (c * a) <= #[trigger] (c * b))),
