...
//            },
//            // TODO: The WalkN stutter steps are fine if I drop the `used_addrs` field, which
//            // depends on whether or not we want to make the assumption that the memories are
//            // disjoint.
