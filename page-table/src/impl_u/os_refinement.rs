...
proof fn step_MapStart_refines(
    c: os::Constants,
    s1: os::State,
    s2: os::State,
    ult_id: nat,
...
//proof fn step_MapEnd_refines(c: os::Constants, s1: os::State, s2: os::State, core: Core)
//    requires
//        s1.inv(c),
//        s2.inv(c),
//        os::step_MapEnd(c, s1, s2, core),
//        s1.sound,
//    ensures ({
//        &&& s1.core_states[core] matches os::CoreState::MapDone { ult_id, result, .. }
//        &&& hlspec::step_MapEnd(c.interp(), s1.interp(c), s2.interp(c), ult_id, result)
//    }),
//{
//    broadcast use to_rl1::next_refines;
//    let hl_c = c.interp();
...
proof fn step_UnmapStart_refines(
    c: os::Constants,
    s1: os::State,
    s2: os::State,
    ult_id: nat,
...
proof fn step_UnmapEnd_refines(
    c: os::Constants,
    s1: os::State,
    s2: os::State,
    core: Core,
